namespace API.HtmlTemplates
{
    ...
    {
        public ItemReport(string serverBasePath, string senderEmail, string conplaintEmail, string title, string description, string itemId, string itemtitle )
        {
            this.serverBasePath = serverBasePath;
            this.title = title;
            this.description = description;
            this.senderEmail = senderEmail;
            this.conplaintEmail = conplaintEmail;
            this.itemId = itemId;
        ...
        private readonly string conplaintEmail;
