namespace API.HtmlTemplates
{
    ...
    {
        public PasswordResetConfirmationEmail(string serverBasePath, string code, string email, string name)
        {
                        ...
                        <tr>
                            ...
                            >
                                ...
                                <tr style=""color: #404040; font-size: 14px; line-height: 28px;"">
                                    <td style=""padding: 20px; padding-bottom: 0;"">
                                    There's one one more step before you can reset your password. Let's make sure this is the right
