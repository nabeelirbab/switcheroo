...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20240913193223_AppVersion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Database.Schema.AppVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Infrastructure.Database.Schema.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c6504d5b-858e-4af7-afbf-c4e3218c596e"),
                            Name = "Electronics"
                        },
                        new
                        {
                            Id = new Guid("a72bad54-deac-45fe-bbfb-f0d4de0c9706"),
                            Name = "White Goods"
                        },
                        new
                        {
                            Id = new Guid("6424e547-f5fb-4783-a423-31e0046d6a50"),
                            Name = "Clothing"
                        },
                        new
                        {
                            Id = new Guid("65641e17-1381-4f4f-8738-5a6a8aad6867"),
                            Name = "Furniture"
                        });
                });
            ...
            modelBuilder.Entity("Infrastructure.Database.Schema.CustomNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Infrastructure.Database.Schema.CustomNotificationStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CustomNotificationStatus");
                });
            ...
            modelBuilder.Entity("Infrastructure.Database.Schema.Offer", b =>
                {
                    ...
                    b.Property<bool?>("ConfirmedBySourceUser")
                        .HasColumnType("boolean");

                    b.Property<bool?>("ConfirmedByTargetUser")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Infrastructure.Database.Schema.Item", b =>
                {
                    ...
                    b.HasOne("Infrastructure.Database.Schema.User", "DeletedByUser")
                        .WithMany()
